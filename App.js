...
import { View, Image, Alert, Button, Text, ScrollView} from 'react-native';
...
const App = () => {
  ...
  return (
      <ScrollView>
        ...
        <Icon name = "face-laugh-squint" size={20} color="#B23B23"><Text>WELCOME TO GUESSING GAME!</Text></Icon>
